...
define('viewmodels.copy-params',[],function () {
...
define('text!components/visualizers/stacked-bars/stacked-bars.html',[],function () { return '<style>\n.axis path {\n    fill: none;\n    stroke: #000;\n    shape-rendering: crispEdges;\n}\n</style>\n\n<div data-bind="stackedBars: {data: data, label: $data.label, colors: colors}"></div>\n';});
...
define('components/visualizers/stacked-bars/bindings',['require','knockout','d3','lodash'],function (require) {
...
define('components/visualizers/stacked-bars/stacked-bars',['require','viewmodels.copy-params','text!./stacked-bars.html','./bindings'],function(require) {
