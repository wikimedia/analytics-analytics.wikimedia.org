...
define('text!components/visualizers/table-timeseries/table-timeseries.html',[],function () { return '<div class="flexed" data-bind="style: {height: containerHeight}">\n    <a class="ui blue icon button" data-bind="attr: {href: downloadLink}">\n        <i class="download icon"></i>\n        Download\n    </a>\n    <table class="ui striped definition table" data-bind="table: tableData"></table>\n</div>\n';});

// TABLE BINDING plugin for Knockout http://knockoutjs.com/
// (c) Michael Best
// License: MIT (http://www.opensource.org/licenses/mit-license.php)
// Version 0.4.0
// NOTE: This is a copy from https://github.com/mbest/knockout-table.git#a0a204bb78
//       I had to wrap it in a proper define so it played nice with require
//       I also linted it

define('knockout.table',['require','knockout'],function (require) {
    ...
    ko.bindingHandlers.table = {
        ...
        update: function (element, valueAccessor) {
            ...
            function unwrapItemAndSubscribe(rowIndex1, colIndex1) {
                // Use a data function if provided; otherwise use the column value as a property of the row item
                var rowItem = rows[rowIndex1], colItem = cols[colIndex1],
            ...
            function getItemClass(rowIndex1, colIndex1) {
                if (classItem) {
                    var colItem = cols[colIndex1], classKey = colItem[classItem];
                    if (classKey) {
                        return ko.utils.escape(data[rows[rowIndex1]][classKey]);
                    }
                }
            }
...
define('components/visualizers/table-timeseries/table-timeseries',['require','text!./table-timeseries.html','knockout','knockout.table'],function (require) {
